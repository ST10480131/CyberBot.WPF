...
{//start of class
    ...
    {//start of method
        ...
        add_answers.Add("scam scams often come through fake emails, calls or messages asking for personal info.");
        add_answers.Add("scam never give out banking details or passwords to anyone who contacts you unexpectedly.");
        add_answers.Add("scam if something feels too good to be true online, it probably is — always verify first.");


        add_answers.Add("privacy protect your privacy by limiting the personal information you share online.");
        add_answers.Add("privacy review app permissions regularly and only grant access to what is truly necessary.");
        add_answers.Add("privacy use strong privacy settings on social media and avoid oversharing personal details.");
        ...
        add_answers.Add("curious great, curiosity is the first step to staying safe online!");
        add_answers.Add("curious being curious about cybersecurity means you are already taking it seriously.");
        add_answers.Add("curious i love the curiosity — let's explore that topic together.");
