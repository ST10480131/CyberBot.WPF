...
//start of namespace
  ...
  // References passed in from MainWindow
        ...
        public void error_method(string name, string message, bool isError)
        {
            ...
            {// DodgerBlue
                messageBorder.Background = new SolidColorBrush(Color.FromRgb(245, 247, 250));
                messageBorder.BorderBrush = new SolidColorBrush(Color.FromRgb(0, 120, 212));
            }
            else
            {    //ForrestGreen
               messageBorder.Background = new SolidColorBrush(Color.FromRgb(255, 255, 255));
               messageBorder.BorderBrush = new SolidColorBrush(Color.FromRgb(16, 124, 16));
            }
            ...
            // Cypher name = DeepSkyLine, username = L
            Brush nameColor = name.ToLower().Contains("cypher") ?
                              Brushes.DeepSkyLine : Brushes.LimeGreen;
